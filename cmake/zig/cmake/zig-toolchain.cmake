...
elseif(ZIG_OS STREQUAL "windows")
    ...
    # Fix compiler detection (lld-link: error: unsupported linker arg: /MANIFEST:EMBED)
...
cmake_path(SET ZIG_WRAPPERS_DIR NORMALIZE "${CMAKE_CURRENT_LIST_DIR}/../bin")

# Work around a bug in clangd where 'c++' is reordered on the command line
set(CMAKE_C_COMPILER "${ZIG_WRAPPERS_DIR}/zig-cc${SCRIPT_SUFFIX}" -target ${ZIG_TARGET})
set(CMAKE_C_COMPILER_ID Clang)
set(CMAKE_CXX_COMPILER "${ZIG_WRAPPERS_DIR}/zig-c++${SCRIPT_SUFFIX}" -target ${ZIG_TARGET})
set(CMAKE_CXX_COMPILER_ID Clang)

# This is working (thanks to Simon for finding this trick)
set(CMAKE_AR "${ZIG_WRAPPERS_DIR}/zig-ar${SCRIPT_SUFFIX}")
set(CMAKE_RANLIB "${ZIG_WRAPPERS_DIR}/zig-ranlib${SCRIPT_SUFFIX}")
set(CMAKE_RC_COMPILER "${ZIG_WRAPPERS_DIR}/zig-rc${SCRIPT_SUFFIX}")
