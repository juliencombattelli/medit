...
static Key sdl3_keycode_to_keybind_key(SDL_Keycode keycode)
{
    switch (keycode) {
        ...
        case SDLK_APPLICATION: return KEY_CTXMENU;
        ...
        case SDLK_LEFTPAREN: return KEY_LEFT_PAREN;
        case SDLK_RIGHTPAREN: return KEY_RIGHT_PAREN;
        case SDLK_LEFTBRACE: return KEY_LEFT_BRACE;
        case SDLK_RIGHTBRACE: return KEY_RIGHT_BRACE;
        case SDLK_SEMICOLON: return KEY_SEMICOLON;
        case SDLK_APOSTROPHE: return KEY_QUOTE;
        ...
        case SDLK_EXCLAIM: return KEY_EXCLAM;
        case SDLK_ASTERISK: return KEY_ASTERISK;
        case SDLK_DOLLAR: return KEY_DOLLAR;

        case SDLK_KP_0: return KEY_NPAD_0;
        case SDLK_KP_1: return KEY_NPAD_1;
        case SDLK_KP_2: return KEY_NPAD_2;
        case SDLK_KP_3: return KEY_NPAD_3;
        case SDLK_KP_4: return KEY_NPAD_4;
        case SDLK_KP_5: return KEY_NPAD_5;
        case SDLK_KP_6: return KEY_NPAD_6;
        case SDLK_KP_7: return KEY_NPAD_7;
        case SDLK_KP_8: return KEY_NPAD_8;
        case SDLK_KP_9: return KEY_NPAD_9;
        case SDLK_KP_PLUS: return KEY_NPAD_PLUS;
        case SDLK_KP_MINUS: return KEY_NPAD_MINUS;
        case SDLK_KP_DIVIDE: return KEY_NPAD_DIVIDE;
        case SDLK_KP_MULTIPLY: return KEY_NPAD_MULTIPLY;
...
KeybindEvent keybind_sdl3_translate_event(void* native_event)
{
    ...
    if (sdl_event->type == SDL_EVENT_KEY_DOWN) {
        result.type = sdl_event->key.repeat ? EVENT_KEY_REPEAT : EVENT_KEY_PRESS;
